 ...
 */
lgv.plugins.WMSSource = Ext.extend(gxp.plugins.LayerSource, {
    ...
    constructor: function(config) {
        ...
        lgv.plugins.WMSSource.superclass.constructor.apply(this, arguments);
        if (!this.format) {
    ...
    init: function(target) {
        lgv.plugins.WMSSource.superclass.init.apply(this, arguments);
    ...
    destroy: function() {
        ...
        lgv.plugins.WMSSource.superclass.destroy.apply(this, arguments);
    },
    ...
    createLayerRecord: function(config) {
        ...
        if (original) {
            ...
            layer.addOptions({
                //taking attribution from config
    ...
    getConfigForRecord: function(record) {
        var config = Ext.applyIf(
                lgv.plugins.WMSSource.superclass.getConfigForRecord.apply(this, arguments),
                record.json
            ),
    ...
    getState: function() {
        var state = lgv.plugins.WMSSource.superclass.getState.apply(this, arguments);
        return Ext.applyIf(state, {title: this.title});
    }
    
});

Ext.preg(lgv.plugins.WMSSource.prototype.ptype, lgv.plugins.WMSSource);
