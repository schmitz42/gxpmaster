 ...
 */
lgv.plugins.Measure = Ext.extend(gxp.plugins.Tool, {
    ...
    createMeasureControl: function(handlerType, title) {
        ...
        var makeString = function(metricData) {
            ...
            return metric.toFixed(1) + " " + metricUnit + dim;
        };
...
Ext.preg(lgv.plugins.Measure.prototype.ptype, lgv.plugins.Measure);
